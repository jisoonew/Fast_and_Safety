                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <select id="deliveryType" class="form-select">
                            ...
                            <option value="today">미답변</option>
                            <option value="regular">답변중</option>
                            <option value="reserved">답변 완료</option>
                        </select>
                    </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>홍길동</td>
                            <td>
                                <button class="btn btn-primary" id="detailButton" data-bs-toggle="modal" data-bs-target="#inquiryModal">문의 보기</button>
                                <!-- 해당 행의 모달 창 -->
                                <div class="modal fade" id="inquiryModal" tabindex="-1" aria-labelledby="inquiryModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="inquiryModalLabel">문의 내역 및 답변</h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="닫기"></button>
                                            </div>
                                            <div class="modal-body">
                                                <p><strong>접수일 : 2023-10-29</strong></p>
                                                <p><strong>처리 상태 : 미답변</strong></p>
                                                <p><strong>상품 정보 : 우유</strong></p>
                                                <p><strong>문의 내용 : 배송이 안와요</strong></p>
                                                <p><strong>질문자 : 고객1</strong></p>
                                                <p><strong>처리일 : -</strong></p>
                                                <p><strong>상담사 : 홍길동</strong></p>
                                                <label for="responseText">답변 작성:</label>
