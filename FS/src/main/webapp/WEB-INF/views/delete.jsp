                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                          <li class="breadcrumb-item"><a href="index.html">FS</a></li>
                          ...
                          <div class="card-body">
                            <div class="row">
                              <div class="form-group col-sm-6">
                                <label for="usr" class="blind"><h4>탈퇴 사유</h4></label>
                                <div class="col-sm-3">
                                    <select>
                                        <option selected>선택</option> 
                                        <option>다른 사이트 이용</option> 
                                        <option>기타 사유</option>
                                    </select>
                                </div>
                              </div>
                            ...
                            <div class="form-group">
                              <label for="comment" class="blind"><h4>피드백</h4></label>
                              <textarea class="form-control" rows="7" id="comment" placeholder=""></textarea>
                            </div>
