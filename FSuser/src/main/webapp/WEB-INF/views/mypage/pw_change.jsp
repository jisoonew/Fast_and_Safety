...
<body class="sb-nav-fixed">
    ...
    <form id="form">
        <div id="container_content">
            ...
            <h1 class="mt-5" id="content_title2">비밀번호 변경</h1>
            ...
            <div id="container_pw_text">
                ...
                <input id="pw_text_input1" class="form-control" type="text" placeholder="새 비밀번호"
                    aria-label="default input example">
                <input id="pw_text_input2" class="form-control" type="text" placeholder="새 비밀번호 확인"
                    aria-label="default input example">
            </div>

            <div id="container_pw_btn">
                <div id="cencle_dtn"><button type="button" class="btn btn-outline-dark"
                        style="width: 120px;">취소</button></div>
                <div id="check_dtn"><button type="button" class="btn btn-outline-dark" style="width: 120px;">확인</button>
                </div>
            </div>
        </div>
    </form>
