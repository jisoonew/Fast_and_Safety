...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <h1 class="mt-4" id="content_title">MY 창고</h1>
...
<button type="button" id="search_dtn" class="btn btn-outline-dark">검색</button>
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th scope="col" style="width: 20%">컨테이너</th>
					<th scope="col" style="width: 20%">물품명</th>
					<th scope="col" style="width: 10%">종류</th>
					<th scope="col" style="width: 10%">온도</th>
					<th scope="col" style="width: 10%">습도</th>
					<th scope="col" style="width: 10%">밝기</th>
				</tr>
			</thead>
	...
	<div id="container_storage_state_table">
      ...
      <td><select id="ex_select">
        <option selected>온도</option>
        <option>한국</option>
        <option>일본</option>
        <option>중국</option>
    </select></td>
      <td><select id="ex_select">
        <option selected>습도</option>
        <option>한국</option>
        <option>일본</option>
        <option>중국</option>
    </select></td>
            <td><select id="ex_select">
        <option selected>밝기</option>
        <option>한국</option>
        <option>일본</option>
        <option>중국</option>
    </select></td>
