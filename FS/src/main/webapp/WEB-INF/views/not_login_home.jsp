...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <!-- Services Dropdown -->
                <a class="navbar-brand ps-3" href="product_storage"><!-- 모달 메시지 -->
                    서비스
                </a>
    
            <!-- Warehouses Dropdown -->
                <a class="navbar-brand ps-3" href=""><!-- 모달 메시지 -->
                    창고
                </a>
        ...
        <h1 class="main_image_text">Fast ans safety<br>
        빠르고 안전한 물류 창고</h1>
        </div>
        ...
        효율적인 배송을 지원합니다.</a>
        <br>
        <button type="button" id="main_delivery_btn" class="btn btn-outline-white">배송하러 가기 -></button>
        </div>
        </div>
        ...
        <a>고객의 물류 특성에 맞는<br>
        	맞춤 창고 서비스를 제공합니다.</a>
        <br>
        <button type="button" id="main_storage_btn" class="btn btn-outline-white">창고보러 가기 -></button>
        </div></div>
        </div>
        ...
        <br>
       	<button type="button" id="main_join_btn" class="btn btn-outline-white">회원가입하기 -></button>
       	</div>
        </div>
