                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <div class="small mb-3 text-muted">사용하고 계시던 비밀번호를 이메일로 알려드립니다.</div>
                                    <form>
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputID" type="id" placeholder="" />
                                            <label>아이디</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="/user/login">로그인 하러가기</a>
