            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="mypage_same_day_delivery">My Page</a></li>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">문의 내용</h1>
                        <ol class="breadcrumb mb-4">
                          <li class="breadcrumb-item"><a href="index">FS</a></li>
                          <li class="breadcrumb-item"><a href="ask_list">문의 내역</a></li>
                          <li class="breadcrumb-item active">문의 내용</li>
                        </ol>
                          ...
                          <div class="card-body">
                            ...
                            <div class="row">
                              <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="form-control" id="title" name="title" value="서비스 이용 문의">
                              </div>
                            </div>
                            <hr> <!-- 네 번째 구분선 -->
                            <div class="form-group">
                              <label for="comment" class="blind"><h4>문의 내용</h4></label>
                              <textarea class="form-control" rows="5" id="comment" placeholder="서비스 이용 문의"></textarea>
                            </div>
                            <hr> <!-- 다섯 번째 구분선 -->
                            <div class="row">
                              <div class="form-group col-sm-6">
                                <label for="usr" class="blind"><h4>파일 첨부</h4></label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card mb-4 col-sm-6 mx-auto">
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group">
                                        <label for="comment" class="blind"><h4>답변</h4></label>
                                        <textarea class="form-control" rows="5" id="comment" placeholder="조치하였습니다."></textarea>
                                    </div>
                                </div>
                                <hr> 
