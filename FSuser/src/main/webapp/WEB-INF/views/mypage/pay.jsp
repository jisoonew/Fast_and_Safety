...
<head>
    ...
    <link href="/resources/css/mypage/pay.css" rel="stylesheet" />
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-5">결제 방법</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index">FS</a></li>
                        <li class="breadcrumb-item active">결제 방법</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="bankName">
                                            <option selected disabled>은행을 선택해주세요</option>
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-secondary form-control" id="saveBtn">저장</button>
                                    </div>
                                </div>
                            </div>
                        </div>
