...
<html lang="en">
    ...
    <body>
        <form><br>
            <div class="row">
                <div class="col-1"></div>
                <div class="col-3"><h2>창고 예약 신청</h2></div>
            </div><br><br>

            <div class="row">
                <div class="col-2"></div>
                <div class="col-1"><h4>이름</h4></div>
            ...
            <div class="row">
                <div class="col-2"></div>
                <div class="col-1"><h4>상품 유형</h4></div>
                <div class="col-2">
                ...
                <div class="col-1"></div>
                <div class="col-1"><h4>입고 물량</h4></div>
            ...
            <div class="row">
                ...
                <div class="col-1"></div>
                <div class="col-1"><h4>보관 기간</h4></div>
                <div class="col-2">
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-1" for="postcode"><h5>예상 보관비</h5></div>
                <div class="col-1"></div>
