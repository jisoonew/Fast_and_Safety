...
<body class="sb-nav-fixed">
	...
	<div class="container p-5">
		...
		<form name="table" class="pt-5" role="form" method="post" action="/navbar/view">
...
<select class="form-select" aria-label="Default select example" id="Q_variety" name="Q_variety">
  <option selected><c:out value="${view.q_variety}"/></option>
			...
			<button type="submit" class="btn btn-primary mt-3" ><a href="/navbar/inquiry_change?Q_id=${view.q_id}">문의하기</a></button>
