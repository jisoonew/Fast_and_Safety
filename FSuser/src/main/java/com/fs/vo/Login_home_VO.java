...
public class Login_home_VO {
	...
	String u_email;
	String u_phone;
	String u_company_name;
	String u_company_address;
	String u_member;
	String u_bank;
	String u_mokeytaker;
	String u_acct;
	String postcode;
	String u_detail_address;
	...
	public String getU_mokeytaker() {
		return u_mokeytaker;
	}
	public void setU_mokeytaker(String u_mokeytaker) {
		this.u_mokeytaker = u_mokeytaker;
	}
