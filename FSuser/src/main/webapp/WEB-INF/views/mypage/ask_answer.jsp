...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet"
        ...
        <link href="/resources/css/mypage/ask_answer.css" rel="stylesheet" />
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-5">문의 내용</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index">FS</a></li>
                        <li class="breadcrumb-item"><a href="/mypage/ask_list">문의 내역</a></li>
                        <li class="breadcrumb-item active">문의 내용</li>
                    </ol>
                    <div class="card mb-4 col-sm-6 mx-auto" style="width: 1200px;">
                        <div class="card-body">
                            <div class="row">
