...
<body class="bg-primary">
    <div id="layoutAuthentication" class="pb-5">
                                ...
                                <div class="card-body">
                                    <form id="join_form" method="post">
                                        ...
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control id_input" type="text" name="u_id" />
                                            <label>아이디</label>
                                        </div>
                                        ...
                                        <div class="form-floating mb-3 mb-md-0 mt-1">
                                            <input class="form-control address_input_2" id="inputAddress2"
                                                type="Address" name="u_detail_address" />
                                            <label>상세주소</label>
                                        </div>
                                        ...
                                        <div class="card-footer text-center py-2">
                                            <div class="small">계정이 있으신가요? <a href="/user/login">로그인</a></div>
                                        </div>
                                    </form>
                                </div>
                            </div>
